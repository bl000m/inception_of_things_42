...
argocd app create will --project default --repo https://gitlab.com/root/mpagani.git --path app --dest-namespace dev --dest-server https://kubernetes.default.svc --sync-policy automated --sync-option Prune --upsert
